...
Vamos gerar endereços públicos e chaves privadas e usá-los para realizar transações e verificar essas transações.
...
### #dio.io
## Projeto:
- [Criando e Utilizando a Sua Carteira de Criptomoedas](https://github.com/MarcoSena2210/)

## Tópicos 
- [Pré-requisitos](https://github.com/MarcoSena2210/????/#pr%C3%A9-requisitos)

- [Descrição do Projeto](https://github.com/MarcoSena2210/????/pr%C3%A9-Descriçãodoprojeto)

- [Objetivo](https://github.com/MarcoSena2210/????/pr%C3%A9-Descriçãodoprojeto)

- [Preparação do Ambiente](https://github.com/MarcoSena2210/????/pr%C3%A9-PreparaçãodoAmbiente)
...
[nodejs](https://code.visualstudio.com/download)
...
### 3-Para melhor organização criar uma pasta src (source) e dentro dela o arquivo "createWallet.js" e digitar o código necessário.Ele será responsável por criar nossas carteira, criar as chaves públicas e privadas.
...
### 1º - Abrindo o Electrum  
![Electrum](img/img02_iniciando_electrum.png)

### 2º - Selecione conectar automaticamente
![Electrum](img/img03_conectando_eletrum%20.png)


### 3º - Criando a carteira (pode dar qualquer nome)
![Electrum](img/img04_criando_carteira.png)
![Electrum](img/img05_carteira_padrao.png)
![Electrum](img/img06_carteira_inicial.png)

### 4º - Ele traz um conjunto de palavras
![Electrum](img/img07_conjunto_palavras.png)

## ⚠ Dica: Anote todas as palavras pois irá digitá-las na próxima tela.
##    É importante estar na mesma ordem em que foram exibidas.

![Electrum](img/img08_conjunto_palavras_a_confirmar.png)

### 5º - Será solicitado a criar uma senha
![Electrum](img/img09_cria_senha.png)

### Pode aparecer o warning 
![Electrum](img/img10_warning.png)
## ⚠ Dica: Usei a mesma senha do linux (só para eu lembrar no futuro)

cAqui acabamos de criar nossa carteira no Eletrum
